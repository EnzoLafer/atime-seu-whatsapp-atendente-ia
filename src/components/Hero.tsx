...
const Hero = () => {
  return <section className="relative gradient-hero py-20 md:py-32 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          ease: "easeOut"
            ...
            <h1 className="mb-6 text-destructive-foreground">
              Seu WhatsApp atendendo e agendando sozinho — 24 horas por dia.
            </h1>
            
            <p className="text-xl md:text-2xl mb-8 leading-relaxed text-secondary-foreground">
          ...
          delay: 0.2
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-glow">
              <img src={heroImage} alt="Dashboard de automação Atime com WhatsApp e IA" className="w-full h-auto" />
