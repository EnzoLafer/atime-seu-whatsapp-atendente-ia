...
import { MessageSquareText, CalendarCheck2, Calendar, Bell, Clock, Zap, Brain, Shield } from "lucide-react";
const features = [{
...
const Features = () => {
  return <section className="py-20 md:py-32 gradient-hero">
      <div className="container mx-auto px-4">
        ...
        duration: 0.6
          ...
          <h2 className="mb-6 text-primary-foreground">Recursos do Atime</h2>
          <p className="text-xl max-w-2xl mx-auto text-secondary-foreground">
